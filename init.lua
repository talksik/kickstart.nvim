...
vim.keymap.set("n", "<leader>ct", function()
  vim.cmd("!ctags -f tags -R --exclude=build --exclude=build-sim --exclude=node_modules --exclude=.git .")
  print("ctags regenerated")
end, { desc = "Regenerate ctags", silent = true })

-- Set highlight on search, but clear on pressing <Esc> in normal mode
vim.opt.hlsearch = true
vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>')

-- Go next and previous in quickfix list
vim.keymap.set('n', '<leader>cn', '<cmd>cnext<CR>')
vim.keymap.set('n', '<leader>cp', '<cmd>cprev<CR>')

vim.keymap.set('n', '<leader>e', vim.cmd.Ex)

-- greatest remap ever -- doesn't remove from copy buffer on past
